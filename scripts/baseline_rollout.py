...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', nargs='?', default='../../nara_data/baselines/')
        ...
        for ra_channel in num_channels_1:
            for ac_channel in num_channels_2:
                ...
                if args.test_baselines == 'yes':
                    ...
                    # print('node: {}'.format(env.wrapped.manager.network.components['Resource_0'].available['node']))
                    # print('sr: {}'.format(env.wrapped.manager.network.components['SRLink_0'].available['ports']))
                    # print('ra: {}'.format(env.wrapped.manager.network.components['RALink_0'].available['ports']))
                    # print('ac: {}'.format(env.wrapped.manager.network.components['ACLink_0'].available['ports']))
                    # print('\n')