...
config = {'azure':'/scratch/datasets/azure_cluster/packing_trace_zone_a_v1.sqlite',
            'alibaba':'/scratch/datasets/alibaba/trace_data.sqlite'}
...
class AzureRequestTest(Request):
    ...
    def __init__(self,config_file,id):
        ...
        conn = lite.connect(config['azure'])
...
class AzureRequest(Request):
    ...
    def node_capacity_quantity(self):
        ...
        print('{},{},{},{}'.format(self.requirements['node'],self.requirements['mem'],self.requirements['ports'],self.requirements['holding_time']))
...
class AlibabaRequest(Request):
    ...
    def __init__(self,config_file,id):
        ...
        # conn = lite.connect('/scratch/datasets/azure_cluster/packing_trace_zone_a_v1.sqlite')
        conn = lite.connect(config['alibaba'])
        self.cur = conn.cursor()
        self.node_capacity_quantity()
