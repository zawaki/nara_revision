...
class NetworkManager(GlobalMessageBuffer):
    ...
    def __init__(self,root_directory):
        ...
        # self.graph_copy = copy.deepcopy(self.network.graph)
    ...
    def packing_efficiency(self,sub_type):
        ...
        # used_comps = []
        # for req in self.allocated_requests:
        #     used_comps += list(self.allocated_requests[req].allocations.keys())

        # used_comps = set(used_comps)

        # return len(used_comps)/len(all_comps)
